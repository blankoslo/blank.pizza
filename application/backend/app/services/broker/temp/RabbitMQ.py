...
from app.services.broker.temp.ExchangeType import ExchangeType
from app.services.broker.temp.QueueParams import QueueParams
from app.services.broker.temp.RabbitConsumerMiddleware import (
...
class RabbitMQ:
    ...
    def __get_needed_props(props_needed: List[str], props: spec.BasicProperties):
        ...
        if "correlation_id" in props_needed:
            payload["correlation_id"] = props.correlation_id

        if "reply_to" in props_needed:
            payload["reply_to"] = props.reply_to
