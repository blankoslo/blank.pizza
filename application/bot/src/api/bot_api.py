...
class BotApi:
    ...
    def send_event_finalized(self, timestamp, restaurant_name, slack_ids, bot_token):
    ...
    def send_event_unfinalized(self, timestamp, restaurant_name, slack_ids, bot_token):
        slack_client = SlackApi(token = bot_token)
